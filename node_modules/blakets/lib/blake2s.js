...
exports.blake2sBigInt =
	exports.blake2sHex =
	exports.blake2s =
	exports.blake2sFinal =
	exports.blake2sUpdate =
	exports.blake2sInit =
	exports.blake2sCompress =
	exports.SIGMA =
	exports.BLAKE2S_IV =
	exports.ROTR32 =
	exports.B2S_G =
...
function blake2sCompress(ctx, last) {
	...
	for (i = 0; i < 10; i++) {
		...
		B2S_G(
			...
			8,
			12,
			m[exports.SIGMA[i * 16 + 0]],
			m[exports.SIGMA[i * 16 + 1]]
		);
		B2S_G(
			1,
			5,
			9,
			13,
			m[exports.SIGMA[i * 16 + 2]],
			m[exports.SIGMA[i * 16 + 3]]
		);
		B2S_G(
			2,
			6,
			10,
			14,
			m[exports.SIGMA[i * 16 + 4]],
			m[exports.SIGMA[i * 16 + 5]]
		);
		B2S_G(
			3,
			7,
			11,
			15,
			m[exports.SIGMA[i * 16 + 6]],
			m[exports.SIGMA[i * 16 + 7]]
		);
		B2S_G(
			0,
			5,
			10,
			15,
			m[exports.SIGMA[i * 16 + 8]],
			m[exports.SIGMA[i * 16 + 9]]
		);
		B2S_G(
			1,
			6,
			11,
			12,
			m[exports.SIGMA[i * 16 + 10]],
			m[exports.SIGMA[i * 16 + 11]]
		);
		B2S_G(
			2,
			7,
			8,
			13,
			m[exports.SIGMA[i * 16 + 12]],
			m[exports.SIGMA[i * 16 + 13]]
		);
		B2S_G(
			3,
			4,
			9,
			14,
			m[exports.SIGMA[i * 16 + 14]],
			m[exports.SIGMA[i * 16 + 15]]
		);
	}
...
exports.blake2sCompress = blake2sCompress;
/**
...
exports.blake2sInit = blake2sInit;
/**
...
exports.blake2sUpdate = blake2sUpdate;
/**
...
exports.blake2sFinal = blake2sFinal;
/**
...
function blake2s(input, key, outlen) {
	...
	blake2sUpdate(ctx, (0, util_1.normalizeInput)(input));
 ...
 */
function blake2sBigInt(input, key, outlen) {
...
exports.blake2sBigInt = blake2sBigInt;
