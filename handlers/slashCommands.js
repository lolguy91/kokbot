										...
										if (
											...
											subcommand.addStringOption((op) =>
												op
													...
													.addChoices(
														option.StringChoices.choices.map(
															(c) => [
																String(c[0])
																	.replace(
																		/\s+/g,
					...
					guild.commands
						...
						.then((slashCommandsData) => {
							console.log(
								...
								} Loaded for: ${`${guild.name}`.underline}`
									.brightGreen
							);
						})
						.catch((e) => console.log(e));
