			...
			message.reply({
				embeds: [
					new Discord.MessageEmbed()
						...
						.setTitle(
							`:thumbsup: **My Prefix here, is __\`${prefix}\`__**`
						),
				],
			});
		}
					...
					.reply({
						embeds: [
							new Discord.MessageEmbed()
								...
								.setTitle(
									replacemsg(
										settings.messages.notallowed_to_exec_cmd
											.title
									)
								)
								.setDescription(
							...
							new Discord.MessageEmbed()
								...
								.setDescription(
									command.argsmissing_message &&
										command.argsmissing_message.trim()
											.length > 0
										? command.argsmissing_message
										: command.usage
										? "Usage: " + command.usage
							...
							new Discord.MessageEmbed()
								...
								.setDescription(
									command.argstoomany_message &&
										command.argstoomany_message.trim()
											.length > 0
										? command.argstoomany_message
										: command.usage
										? "Usage: " + command.usage
					...
					.reply({
						embeds: [
							new Discord.MessageEmbed()
								...
								.setTitle(
									replacemsg(
										settings.messages.somethingwentwrong_cmd
											.title,
										{
											prefix: prefix,
											command: command,
